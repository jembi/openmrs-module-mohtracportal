 ...
 * 
 */
package org.openmrs.module.mohtracportal.db;
 ...
 * 
 */
public interface MohTracPortalDAO {
	...
	public List<SampleCode> getAllSampleTestByPerson(Person p) throws Exception;
	...
	// firstOrLast : 0 means first, 1 means last
	public String getDateOfFirstOrLastRecordByObjectAndByUser(Integer userId,
			Integer objectId, Integer firstOrLast) throws Exception;
