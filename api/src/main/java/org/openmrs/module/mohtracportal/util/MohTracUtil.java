...
public class MohTracUtil {
	...
	private static Log log = LogFactory.getLog(MohTracUtil.class);
	...
	public static HashMap<Integer, String> createNewProviderOptions() {
		...
		log.info("<<<<<<<<<<<<<_____Providers list size____ " + realProviders.size() + " _______>>>>>>>>>>>");
	...
	public static HashMap<Integer, String> createIdentifierTypesOptions() {
		...
		if (idTypes != null) {
			for (PatientIdentifierType pit : idTypes) {
				idTypesOptions.put(pit.getPatientIdentifierTypeId(),
						pit.getName());
			}
		}
	...
	public static HashMap<Integer, String> createLocationOptions() {
		...
		if (locations != null) {
			for (Location location : locations) {
				locationOptions.put(location.getLocationId(),
						location.getName());
			}
		}
	...
	public static HashMap<Integer, String> createAttributesOptions() {
		...
		if (attributes != null) {
			for (PersonAttributeType attrib : attributes) {
				attributeOptions.put(attrib.getPersonAttributeTypeId(),
						attrib.getName());
			}
		}
	...
	public static String getMessage(String messageId, Object[] parameters) {
		...
		String msg = ContextProvider.getMessage(messageId, parameters);
	...
	public static HashMap<Integer, String> createWHOStageAdultOptions() {
		...
		for (int conceptId : getAdultWHOStagePossibleOptions()) {
			...
			whoStageOptions.put(c.getConceptId().intValue(),
					c.getDisplayString());
		}
